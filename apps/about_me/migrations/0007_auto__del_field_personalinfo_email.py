...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PersonalInfo.email'
        db.delete_column(u'about_me_personalinfo', 'email')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PersonalInfo.email'
        raise RuntimeError("Cannot reverse this migration. 'PersonalInfo.email' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PersonalInfo.email'
        db.add_column(u'about_me_personalinfo', 'email',
    ...
    models = {
        u'about_me.contact': {
            ...
            'order': ('django.db.models.fields.SmallIntegerField', [], {'default': '9'}),
