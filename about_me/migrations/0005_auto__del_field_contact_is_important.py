...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contact.is_important'
        db.delete_column(u'about_me_contact', 'is_important')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contact.is_important'
        raise RuntimeError("Cannot reverse this migration. 'Contact.is_important' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Contact.is_important'
        db.add_column(u'about_me_contact', 'is_important',
